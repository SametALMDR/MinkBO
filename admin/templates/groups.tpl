                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                        ...
                        {foreach $grs as $key => $g}
                            <tr>
                                <td>{$key+1}</td>
                                <td><a href="{$ADMIN_ROOT}/user.php?uid={$g->uid}" target="_blank">{$g->uname} {$g->surname}</a></td>
                                <td>{$g->name}</td>
                                <td>{mb_substr($g->description,0,100)}</td>
                                <td class="d-flex justify-content-center">
                                    <!-- <a class="view-row mr-3 pointer" style="color: rgb(134 134 134);"><i class="far fa-eye"></i></a> -->
                                    <a class="update-row mr-3 pointer" href="{$ADMIN_ROOT}/group.php?gid={$g->gid}" style="color: rgb(0 34 128);">
                                        <i class="far fa-edit"></i>
                                    </a>
                                    <form action="" method="post">
                                        <button name="delete-row" value="{$g->gid}" class="delete-row b-none" style="color: rgb(224, 6, 6);">
