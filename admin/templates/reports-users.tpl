                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                        ...
                        {foreach $reports as $key => $r}
                            <tr>
                                ...
                                <td><a href="{$ADMIN_ROOT}/user.php?uid={$r->u2uid}" target="_blank">{$r->u2name} {$r->u2surname}</a></td>
                                <td><a href="{$ADMIN_ROOT}/user.php?uid={$r->u1uid}" target="_blank">{$r->u1name} {$r->u1surname}</a></td>
