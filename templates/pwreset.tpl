                        ...
                        <div class="col-lg-6 order-1 order-lg-2 d-flex align-items-center justify-content-center login-right-bg">
                            <div class="signup-form-wrapper">
                                <div class="signup-inner text-center">
                                    ...
                                    {if isset($get['token'])}
                                        {if $istoken && empty($ok)}
                                            <form class="signup-inner--form" method="post" action="?token={$get['token']}">
                                                <div class="row">
                                                    <div class="col-12">
                                    ...
                                    {else}
                                        <form class="signup-inner--form" method="post" action="">
                                            <div class="row">
                                                <div class="col-12">
                                                    <input type="email" name="email" class="single-field" value="{if isset($post['email'])}{$post['email']}{/if}" placeholder="E-posta adresi" required>
                                                </div>
                                                <div class="col-12">
                                                    <button class="bg-secondary shadow-lg submit-btn mt-3" name="reset">Sıfırla</button>
                                                    <h6 class="terms-condition pt-3 font-weight-italic font-weight-light"><a href="{$WEB_ROOT}/login.php" class="text-dark">Geri Dön</a></h6>
                                                </div>
                                            </div>
                                        </form>
                                    {/if}
