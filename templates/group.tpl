                        ...
                        <div class="share-box-inner">
                            ...
                            <div class="share-content-box w-100">
                                <form class="share-text-box">
                                    <textarea name="share" class="share-text-field" aria-disabled="true" placeholder="Ne yapıyorsun, {ucfirst($lguser->name)} ?" data-toggle="modal" data-target="#textbox"></textarea>
                                </form>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body custom-scroll">
                                            <form action="{$WEB_ROOT}/group.php?gid={$get['gid']}" method="post" enctype="multipart/form-data">
                                                <textarea name="share" class="share-field-big custom-scroll" placeholder="Ne yapıyorsun, {ucfirst($lguser->name)} ?"></textarea>
                                                <div class="row">
                                                    <div class="col-md-12">
