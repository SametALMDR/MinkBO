<?php
/* Smarty version 3.1.36, created on 2021-01-10 01:58:47
  from 'C:\xampp\htdocs\MinkBo\templates\talk.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5ffa3527cb24d6_22705080',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '32fb1867fc25c2c2d64caa5bdeeba0c804c4494e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\MinkBo\\templates\\talk.tpl',
      1 => 1610233126,
      2 => 'file',
    ),
  ),
...
function content_5ffa3527cb24d6_22705080 (Smarty_Internal_Template $_smarty_tpl) {
?><main>
                    ...
                    <div class="card">
                        <div class="share-box-inner">
                            ...
                            <div class="profile-thumb">
                                <?php if ($_smarty_tpl->tpl_vars['lguser']->value->secret_opt_name) {?>
                                    <a href="#">
                                        <figure class="profile-thumb-middle rounded-0">
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['WEB_ROOT']->value;?>
/img/unknown-user.png" alt="profile picture" style="opacity: 0.3">
                                        </figure>
                                    </a>
                                <?php } else { ?>
...
" alt="profile picture">
                            ...
                            <div class="share-content-box w-100">
                                <form class="share-text-box">
                                    <textarea name="share" class="share-text-field" aria-disabled="true" placeholder="Derdini anlat <?php echo $_smarty_tpl->tpl_vars['lguser']->value->name;?>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Derdini Anlat</h5>
                                        ...
                                        <div class="modal-body custom-scroll">
                                            <form action="" method="post" enctype="multipart/form-data">
                                                <textarea name="share" class="share-field-big custom-scroll" placeholder="Derdini anlat <?php echo $_smarty_tpl->tpl_vars['lguser']->value->name;?>
..."></textarea>
                                                <div class="row">
                                                    <div class="col-md-12">
...
?>
                        ...
                        <div class="card">
                            ...
                            <div class="post-title d-flex align-items-center">
                                <!-- profile picture end -->
                                <div class="profile-thumb">
                                    <?php if ($_smarty_tpl->tpl_vars['post']->value->secret_opt_name) {?>
                                        <a href="#">
                                            <figure class="profile-thumb-middle rounded-0">
                                                <img src="<?php echo $_smarty_tpl->tpl_vars['WEB_ROOT']->value;?>
/img/unknown-user.png" alt="profile picture" style="opacity: 0.3">
...
" alt="profile picture">
                                ...
                                <div class="posted-author">
                                    <h6 class="author">
                                        <?php if ($_smarty_tpl->tpl_vars['post']->value->secret_opt_name) {?>
                                            <a href="#">
                                                anonymous  <span class="text-truncate">user</span>
                                            </a>
                                        <?php } else { ?>
                                            <a href="<?php echo $_smarty_tpl->tpl_vars['WEB_ROOT']->value;?>
/profile.php<?php if ($_smarty_tpl->tpl_vars['post']->value->uid != $_smarty_tpl->tpl_vars['lguser']->value->uid) {?>?uid=<?php echo $_smarty_tpl->tpl_vars['post']->value->uid;
...
?>
                                        <div class="share-box-inner mb-1">
                                            <div class="profile-thumb">
                                                <?php if ($_smarty_tpl->tpl_vars['comment']->value->secret_opt_name) {?>
                                                    <a href="#">
                                                        <figure class="profile-thumb-middle rounded-0">
                                                            <img src="<?php echo $_smarty_tpl->tpl_vars['WEB_ROOT']->value;?>
/img/unknown-user.png" alt="profile picture" style="opacity: 0.3">
                                                        ...
                                                        <div class="pl-3">
                                                            <p class="comment-bg">
                                                                <span class="d-flex justify-content-between">
                                                                    <?php if ($_smarty_tpl->tpl_vars['comment']->value->secret_opt_name) {?>
                                                                        <a href="#" class="text-capitalize comment-user">
                                                                            anonymous user
                                                                            <?php if ($_smarty_tpl->tpl_vars['comment']->value->uid == $_smarty_tpl->tpl_vars['lguser']->value->uid) {?>
                                                                                (Sen)
                                                                            <?php }?>
                                                                        </a>
                                                                    <?php } else { ?>
...
?>
                                                                <div class="share-box-inner mt-2 mb-3">
                                                                    <div class="profile-thumb">
                                                                        <?php if ($_smarty_tpl->tpl_vars['s']->value->secret_opt_name) {?>
                                                                            <a href="#">
                                                                                <figure class="profile-thumb-middle rounded-0">
                                                                                    <img src="<?php echo $_smarty_tpl->tpl_vars['WEB_ROOT']->value;?>
/img/unknown-user.png" alt="profile picture" style="opacity: 0.3">
                                                                                ...
                                                                                <div class="pl-3">
                                                                                    ...
                                                                                    <span class="d-flex justify-content-between">
                                                                                        <?php if ($_smarty_tpl->tpl_vars['s']->value->secret_opt_name) {?>
                                                                                            <a href="#" class="text-capitalize comment-user">
                                                                                                anonymous user
                                                                                                <?php if ($_smarty_tpl->tpl_vars['s']->value->uid == $_smarty_tpl->tpl_vars['lguser']->value->uid) {?>
                                                                                                    (Sen)
                                                                                                <?php }?>
                                                                                            </a>
                                                                                        <?php } else { ?>
...
" alt="profile picture">
                                        ...
                                        <div class="share-content-box w-100">
                                            <form class="share-text-box send-comment" action="" data-type="secret" id="main-comment-form">
...
?>
                        <div class="card text-center pointer" style="padding: 125px 0;" data-toggle="modal" data-target="#textbox">
                            <p style="font-size: 35px;color: #efece8;">Hadi sorunlarını bizimle paylaş...</p>
                        </div>
                    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
